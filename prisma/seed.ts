...
async function main() {
  ...
  const spotsData = [
    ...
    },
    {
      ...
      address: "Bahçelievler Mah. Hastane Arkası Sok. No: 12, Rize",
      lat: 41.0180,
      lng: 40.5195,
      category: "bireysel",
      spotType: "kapali",
    ...
    },
    {
      ...
      description: "Devlet hastanesine ve eczanelere çok yakın. Temiz ve korunaklı şahıs garajı.",
      address: "Bahçelievler Mah. Sağlık Sok. No: 3, Rize",
      lat: 41.0168,
      lng: 40.5205,
      category: "bireysel",
      spotType: "kapali",
